    ...
    <section id="section-about" class="section-about">
        ...
        <div class="row">
            <div class="col-1-of-2">
                ...
                <p class="paragraphe">
                    Je m'appelle Khai-way, je suis webdesigner et développeur web depuis peu suite à une reconversion profesionnelle dans le milieu de la vente.
                    Passionné par le développement web, j'aime expérimenter, découvrir et apprendre des nouvelles technologies.
                    Je suis actuellement à la recherche d'un contrat en alternance.
                </p>
